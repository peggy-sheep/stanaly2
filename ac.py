...
if selected_status_2 =='season':
    ...
    if selected_status_7 =='bar chart':
        if selected_status_6 =='spring':
            ...
            # Change the bar mode
            fig.update_layout(barmode='group',title='The number of charging piles used in different regions',yaxis_title='usage count')
        ...
        if selected_status_6 =='spring':
            fig = go.Figure(data=[go.Pie(labels=labels, values=pie_spring, textinfo='label+percent',insidetextorientation='radial',textfont=dict(size=15))])
            fig.update_layout(title='The number of charging piles used in different regions')
        elif selected_status_6 =='summer':
            fig = go.Figure(data=[go.Pie(labels=labels, values=pie_summer, textinfo='label+percent',insidetextorientation='radial',textfont=dict(size=15))])
            fig.update_layout(title='The number of charging piles used in different regions')
        elif selected_status_6 =='autumn':
            fig = go.Figure(data=[go.Pie(labels=labels, values=pie_autumn, textinfo='label+percent',insidetextorientation='radial',textfont=dict(size=15))])
            fig.update_layout(title='The number of charging piles used in different regions')
        elif selected_status_6 =='winter':
            fig = go.Figure(data=[go.Pie(labels=labels, values=pie_winter, textinfo='label+percent',insidetextorientation='radial',textfont=dict(size=15))])
            fig.update_layout(title='The number of charging piles used in different regions')
        ...
        if selected_status_6 =='spring':
            ...
            fig.update_layout(
                ...
                title='The number of charging piles used in different regions',
    ...
    if selected_status_5 == 'bar chart':
        ...
        if selected_status_2 == 'day':
            fig = px.bar(df, x='Start_Date', y= selected_status_3, title='Daily use of the '+ selected_status_3)
            ...
            fig = px.bar(df4_week, x='day_of_week', y=selected_status_3, title=selected_status_3 + ' use per week')
            fig.update_traces(marker_color='rgb(161, 178, 133)', marker_line_color='rgb(161, 178, 133)', marker_line_width=1.5)
            
        else:
            fig = px.bar(df_by_month, x=df_by_month .index, y=selected_status_3, title=selected_status_3 + ' use per month')
        ...
        if selected_status_2 == 'day':
            fig = px.line(df, x='Start_Date', y= selected_status_3, title='Daily use of the '+ selected_status_3)
            fig.update_traces(line_color='rgb(166, 204, 227)', marker_line_width=1.5)
            output = 1
        elif selected_status_2 == 'week':
            fig = px.line(df4_week, x='day_of_week', y=selected_status_3, title=selected_status_3 + ' use per week')
            fig.update_traces(line_color='rgb(161, 178, 133)', marker_line_width=1.5)
            output = 2
        else:
            fig = px.line(df_by_month, x=df_by_month .index, y=selected_status_3, title=selected_status_3 + ' use per month')
            fig.update_traces(line_color='rgb(200, 138, 113)', marker_line_width=1.5)
            output = 3

    elif selected_status_5 == 'box chart':
        if selected_status_2 == 'day':
            fig = px.box(df2, x='day_of_month', y= selected_status_3, title='Daily use of the '+ selected_status_3)
            fig.update_traces(line_color='rgb(166, 204, 227)', marker_line_width=1.5)
            output = 1
        elif selected_status_2 == 'week':
            fig = px.box(df2, x='day_of_week', y=selected_status_3, title=selected_status_3 + ' use per week')
            fig.update_traces(line_color='rgb(161, 178, 133)', marker_line_width=1.5)
            output = 2
        else:
            fig = px.box(df2, x='month', y=selected_status_3, title=selected_status_3 + ' use per month')
            fig.update_traces(line_color='rgb(200, 138, 113)', marker_line_width=1.5)
            output = 3
